...
export default async function SourceAvailabilityFixturePage({
  ...
  return (
    <main className="min-h-screen bg-[var(--app-bg)] px-5 py-10 text-white">
      <section className="mx-auto max-w-3xl rounded-2xl border border-white/8 bg-[var(--app-surface)] p-6">
