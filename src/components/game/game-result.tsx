...
export function GameResult({
  ...
  state: Pick<GameState, "theme" | "session">;
  result: NonNullable<ReturnType<typeof projectCompletedGame>>;
  sessionId: string;
}) {
    ...
    <main className="relative min-h-screen overflow-hidden bg-[var(--app-bg)] px-5 py-10 text-white sm:px-8">
      <div className="relative mx-auto max-w-5xl">
        <section className="border-t-4 border-b-4 border-t-[var(--duel-a)] border-b-[var(--duel-b)] py-8 text-center">
          ...
          <div className="mx-auto mt-7 aspect-video max-w-2xl overflow-hidden rounded-sm border-r-4 border-l-4 border-r-[var(--duel-b)] border-l-[var(--duel-a)]">
        ...
        <section
          className="mx-auto mt-12 max-w-4xl rounded-2xl border-t-4 border-[var(--duel-b)] bg-[var(--app-surface)] p-5 sm:p-7"
        ...
        >
          <div className="grid items-center gap-7 md:grid-cols-[minmax(0,1fr)_260px]">
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                <a
                  ...
                  className={cn(
                    ...
                    "min-h-12 rounded-md bg-[var(--duel-a)] px-5 font-bold text-[var(--app-bg)] hover:brightness-110",
                  )}
                >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group mx-auto block w-full max-w-[260px] overflow-hidden rounded-sm border border-white/10 bg-black/25 shadow-xl outline-none focus-visible:ring-2 focus-visible:ring-white"
                ...
                >
                  ...
                  {[songA, songB].map((song, index) => (
                    <p
                      ...
                      className={cn(
                        "mt-3 flex items-center justify-between gap-3 rounded-md border-l-4 px-3 py-2 text-sm",
                        index === 0
                          ? "border-l-[var(--duel-a)]"
                          : "border-l-[var(--duel-b)]",
