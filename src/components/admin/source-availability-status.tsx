...
const tones = {
  ...
  unknown: "border-white/10 text-[var(--app-muted)]",
} as const;
...
export function SourceAvailabilityStatus({
  ...
  return (
    <div className="mt-4 rounded-md border border-white/8 bg-white/[0.025] p-4">
      ...
      {observation ? (
        <dl className="mt-3 grid gap-2 text-xs text-[var(--app-muted)] sm:grid-cols-2 xl:grid-cols-4">
          <div>
          ...
          <div>
            <dt className="font-semibold text-[var(--app-muted)]">Validade</dt>
            <dd className="mt-1">
